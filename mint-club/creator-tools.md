...
Distribute tokens or NFTs to a list of recipients. Airdrops support **targeted
distribution**, including by **Farcaster IDs**, so creators can reward a specific community
(for example, a project's Farcaster followers) rather than only raw wallet lists.
